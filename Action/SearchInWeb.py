...
RESEARCH_TOPIC_SYSTEM = "You are an {status}, and your research topic is:\n#TOPIC#\n{topic}"
...
class CollectLinks(Action):
    ...
    search_engine: SearchEngine = SearchEngine(engine=SearchEngineType.DIRECT_GOOGLE)
...
def get_research_system_text(status: str, topic: str, language: str):
    ...
    """
    return " ".join((RESEARCH_TOPIC_SYSTEM.format(status=status, topic=topic), LANG_PROMPT.format(language=language)))
